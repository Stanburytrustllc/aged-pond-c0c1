...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aged-pond-c0c1
```

A live public deployment of this template is available at [https://aged-pond-c0c1.templates.workers.dev](https://aged-pond-c0c1.templates.workers.dev)
